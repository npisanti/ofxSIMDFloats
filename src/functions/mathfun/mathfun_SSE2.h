...
/* SIMD (SSE1+MMX or SSE2) implementation of sin, cos, exp and log
    ...
    /* Copyright (C) 2007  Julien Pommier
     ...
     MODIFIED Nicola Pisanti 2016 for including natively into ofxSIMDFloats
*/

#ifndef OFX_SIMDFLOATS_MATHFUN_SSE2_H_INCLUDED
#define OFX_SIMDFLOATS_MATHFUN_SSE2_H_INCLUDED
...
static const ALIGN16_BEG Type _ps_##Name[4] ALIGN16_END = { Val, Val, Val, Val }
    ...
    _PS_CONST(c_mathfun_ln2, 0.69314718055994530942);
    inline_f f128 m_pow2(f128 x){
        f128 expvalue = _mm_mul_ps(x, *(v4sf*)_ps_c_mathfun_ln2);
        return m_exp(expvalue);
    }
